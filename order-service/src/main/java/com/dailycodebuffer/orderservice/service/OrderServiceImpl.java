...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse getOrderDetails(long orderId) {
        ...
        Order order = orderRepository.findById(orderId)
                .orElseThrow(() -> new OrderServiceCustomException("Order not found for order Id: " + orderId, "NOT_FOUND", 404));
        ...
        log.info("Getting payment information form the payment Service for order id: {}", order.getId());
